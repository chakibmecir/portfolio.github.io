$(document).ready(function() {
    $("#bg__toggle").click(function() {
    $(".darkmode__toggle").toggleClass("darkmode__toggle__active");
    $(".logo__contain").toggleClass("logo__contain__inverted");
});
});
...
$(document).ready(function() {
    ...
    $(".dark-span").toggleClass("span-white");
    $("i").toggleClass("icons-white");
    $(".menuV2__container").toggleClass("navbar-dark");
    $(".content__item-description").toggleClass("text-dark");
});
});
